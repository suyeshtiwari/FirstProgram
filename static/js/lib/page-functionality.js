(function($) {
    ...
    $(document).ready(function() {
        ...
        //var minSlot = parseInt($(".durationBlock").text()) + 1 ;
         window.gridHelper = function($this){
            ...
            $("#calucateAmount").click();
        }
        window.gridMouseEnterHelper = function($this){
            $("#calucateAmount").click();
            if(startChosen) {
        ...
        $(document).on('mouseleave', ".gridContainer", function(){
        	 	$("#calucateAmount").click();
            if(startChosen){  
                $(".hoverGrid").removeClass("hoverGrid");
                $(".currentHover").removeClass("currentHover");
        ...
        $(".locationBlock").on('click',function() {
            console.log($('.locationOption').is(':visible'))
            if($('.locationOption').is(':visible')){
                $(".locationOption").hide();
            }else{
                 $(".locationOption").show();
            }
        ...
        $(document).on('click', ".mobileMenu", function(){
            if(menuVisible){
                $('.dropDownAccount').hide('fast',function(){
                     menuVisible = false;
                });
            }else{
                $('.dropDownAccount').show('fast',function(){
                    menuVisible = true;
                });
            }
            
        })
        $(".bookingType").first().addClass('active')
        $(document).on("click", ".bookingType",function(){
